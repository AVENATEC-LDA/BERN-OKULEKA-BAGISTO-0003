        ...
        'index' => [
            ...
            'customer' => [
                ...
                'captcha' => [
                    ...
                    'credentials' => [
                        ...
                        'status' => 'Статус',
                        'title' => 'Облікові дані',
                        'title-info' => 'Встановіть облікові дані Google reCAPTCHA, включаючи ключ API, ID проекту, ключ сайту, секретний ключ та увімкніть або вимкніть статус.',
                    ],
            ...
            'email' => [
                ...
                'smtp' => [
                    ...
                    'host' => 'Хост',
                    'info' => 'Налаштуйте параметри SMTP-сервера для надсилання електронних листів з вашого магазину.',
                    'password' => 'Пароль',
                    'port' => 'Порт',
                    'title' => 'SMTP',
                ...
                'email-settings' => [
                    ...
                    'info' => 'Налаштуйте ім\'я відправника, адресу електронної пошти магазину, дані адміністратора та контактні дані, що використовуються в усіх листах.',
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'payu' => 'PayU',
                    'payu-info' => 'Налаштування параметрів платіжного шлюзу PayU',
