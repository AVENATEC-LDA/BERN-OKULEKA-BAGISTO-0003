        ...
        'index' => [
            ...
            'customer' => [
                ...
                'captcha' => [
                    ...
                    'credentials' => [
                        ...
                        'title-info' => 'Установите учетные данные Google reCAPTCHA, включая ключ API, ID проекта, ключ сайта, секретный ключ, а также включите или отключите статус.',
                    ],
            ...
            'email' => [
                ...
                'smtp' => [
                    ...
                    'host' => 'Хост',
                    'info' => 'Настройте параметры SMTP-сервера для отправки писем из вашего магазина.',
                    'password' => 'Пароль',
                    'port' => 'Порт',
                    'title' => 'SMTP',
                ...
                'email-settings' => [
                    ...
                    'info' => 'Настройте имя отправителя, адрес электронной почты магазина, данные администратора и контактные данные, используемые во всех письмах.',
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'payu' => 'PayU',
                    'payu-info' => 'Настройка параметров платежного шлюза PayU',
                    ...
                    'status' => 'Статус',
                    'stripe' => 'Stripe',
                    'stripe-info' => 'Настройте параметры платёжного шлюза Stripe для безопасных онлайн-транзакций',
