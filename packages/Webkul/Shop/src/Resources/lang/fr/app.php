...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Droits d’auteur 2010 - :current_year, AVENATEC LDA (enregistré en Inde). Tous droits réservés.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text' => '© Copyright 2010 - :current_year, :company_link (enregistré en Inde). Tous droits réservés.',
                'locale' => 'Langue',
