...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Derechos de autor 2010 - :current_year, AVENATEC LDA (Registrado en India). Todos los derechos reservados.',
        ...
        'reset-password' => [
            ...
            'footer' => '© Derechos de autor 2010 - :current_year, AVENATEC LDA (Registrada en India). Todos los derechos reservados.',
            'password' => 'Contraseña',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text' => '© Derechos de autor 2010 - :current_year, :company_link (registrada en India). Todos los derechos reservados.',
                'locale' => 'Idioma',
