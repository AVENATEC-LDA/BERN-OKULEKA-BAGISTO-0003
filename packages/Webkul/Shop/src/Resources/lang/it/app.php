...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Copyright 2010 - :current_year, AVENATEC LDA (Registrato in India). Tutti i diritti riservati.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text' => '© Copyright 2010 - :current_year, :company_link (registrato in India). Tutti i diritti riservati.',
                'locale' => 'Lingua',
